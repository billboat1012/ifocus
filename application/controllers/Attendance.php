    ...
    public function student_entry()
    {
        ...
        if (isset($_POST['search'])) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $this->data['date'] = $date;
                $this->data['attendencelist'] = $this->attendance_model->getStudentAttendence($classID, $date, $branchID);
            }
        }
    ...
    public function exam_entry()
    {
        ...
        if (isset($_POST['search'])) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $this->data['attendencelist'] = $this->attendance_model->getExamAttendence($classID, $examID, $subjectID, $branchID);
            }
        }
    ...
    public function studentwise_overview()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $this->data['end'] = $end;
                $this->data['studentlist'] = $this->application_model->getStudentListByClassSection($this->data['class_id'], $branchID);
            }
        }
