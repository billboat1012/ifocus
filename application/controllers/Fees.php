...
class Fees extends Admin_Controller
{
    ...
    public function allocation()
    {
        ...
        if (isset($_POST['search'])) {
            ...
            $this->data['branch_id'] = $branchID;
            $this->data['studentlist'] = $this->fees_model->getStudentAllocationList($this->data['class_id'], $this->data['fee_group_id'], $branchID);
        }
        if (isset($_POST['save'])) {
    ...
    public function invoice_list()
    {
        ...
        if ($this->input->post('search')) {
            $this->data['class_id'] = $this->input->post('class_id');
            $this->data['section_id'] = $this->input->post('section_id');
            $this->data['invoicelist'] = $this->fees_model->getInvoiceList($this->data['class_id'], $branchID);
        }
        $this->data['branch_id'] = $branchID;
    ...
    public function due_invoice()
    {
        ...
        if ($this->input->post('search')) {
            ...
            $this->data['invoicelist'] = $this->fees_model->getDueInvoiceList($this->data['class_id'], $feegroup_id, $fee_feetype_id);
        }
        $this->data['branch_id'] = $branchID;
        $this->data['title'] = translate('payments_history');
    ...
    public function due_report()
    {
        ...
        if ($this->input->post('search')) {
            $this->data['class_id'] = $this->input->post('class_id');
            $this->data['section_id'] = $this->input->post('section_id');
            $this->data['invoicelist'] = $this->fees_model->getDueReport($this->data['class_id']);
        }
        $this->data['branch_id'] = $branchID;
    ...
    public function student_fees_report()
    {
        ...
        if ($this->input->post('search')) {
            ...
            $start = date("Y-m-d", strtotime($daterange[0]));
            $end = date("Y-m-d", strtotime($daterange[1]));
            $this->data['invoicelist'] = $this->fees_model->getStuPaymentReport($classID, $enroll_id, $typeID, $start, $end, $branchID);
        }
        $this->data['branch_id'] = $branchID;
    ...
    public function fine_report()
    {
        ...
        if ($this->input->post('search')) {
            ...
            $start = date("Y-m-d", strtotime($daterange[0]));
            $end = date("Y-m-d", strtotime($daterange[1]));
            $this->data['invoicelist'] = $this->fees_model->getStuPaymentHistory($classID, $paymentVia, $start, $end, $branchID, true);
        }
        $this->data['branch_id'] = $branchID;
