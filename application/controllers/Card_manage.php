...
class Card_manage extends Admin_Controller
{
    ...
    public function generate_student_idcard()
    {
        ...
        if ($_POST) {
            ...
            $this->data['stuList'] = $this->application_model->getStudentListByClassSection($classID, $branchID, false, false, true, $sessionID);
        }
        $this->data['headerelements'] = array(
            'js' => array(
                'js/certificate.js',
    ...
    public function generate_student_admitcard()
    {
        ...
        if ($_POST) {
            ...
            $classID = $this->input->post('class_id');
            $this->data['stuList'] = $this->application_model->getStudentListByClassSection($classID, $branchID);
        }
        $this->data['headerelements'] = array(
            'js' => array(
                'js/certificate.js',
