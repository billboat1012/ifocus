				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<?php
							...
							echo form_dropdown("class_id", $arrayClass, $homework['class_id'], "class='form-control' id='class_id'
							data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
						?>
						<span class="error"></span>
					</div>
					...
					<div class="col-md-6">
						<?php
							if(!empty($homework['class_id'])) {
								...
								$query = $this->subject_model->getSubjectByClassSection($homework['class_id']);
