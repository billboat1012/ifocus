				...
				<table class="table table-bordered table-hover table-condensed mb-none tbr-top table-export">
					...
					<tbody>
						...
						<?php } ?>
							...
							<td class="text-dark"><?php echo $this->subject_model->get_subject_list($row['class_id']);?></td>
							...
							<?php if (get_permission('subject_class_assign', 'is_edit')): ?>
								...
								<a href="javascript:void(0);" class="btn btn-circle btn-default icon" onclick="getClassAssignM(<?=$row['class_id']?>)">
							...
							<?php endif; if (get_permission('subject_class_assign', 'is_delete')): ?>
								...
								<?php echo btn_delete('subject/class_assign_delete/'. $row['class_id']);?>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<?php
									...
									//echo '<pre>'; print_r($arrayBranch); echo '</pre>';
