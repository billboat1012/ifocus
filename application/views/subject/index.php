...
<?php if (get_permission('subject', 'is_add')): ?>
			<div class="tab-pane" id="create">
				<?php echo form_open('subject/save', array('class' => 'form-horizontal form-bordered frm-submit'));?>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<?php
									...
									echo form_dropdown("branch_id", $arrayBranch, set_value('branch_id'), "class='form-control' id='branch' data-width='100%'
					...
					<div id="subject_category_div" class="form-group" style="display: none;">
                            <label class="col-md-3 control-label"><?= translate('subject_category') ?> <span class="required">*</span></label>
                            <div class="col-md-6">
...
<script>
    $(document).ready(function () {
        ...
        $("#branch").change(function () {
            ...
            var subjectCodeDiv = $("#subject_category_div");
    
            // Toggle visibility based on the selected branch
            if (selectedBranch === specialBranch) {
                subjectCodeDiv.show(); // Show the hidden input
            } else {
                subjectCodeDiv.hide(); // Hide the input if it doesn't match
            }
        });
    });
</script>