		...
		<div class="tab-content">
			<div class="tab-pane active" id="edit">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit'));?>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<?php
									...
									echo form_dropdown("branch_id", $arrayBranch, $class['branch_id'], "class='form-control' id='branch_id' data-width='100%' data-plugin-selectTwo  data-minimum-results-for-search='Infinity'");
								?>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?=translate('parent_class')?></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="parent_class" value="<?=$class['parent_class']?>"/>
							<span class="error"></span>
						</div>
					</div>
