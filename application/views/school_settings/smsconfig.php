					...
					<div id="sms_config" class="tab-pane active">
						...
						<div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-accordion">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#esender">eSender</a>
									</h4>
								</div>
								<div id="esender" class="accordion-body collapse">
									<?php echo form_open('school_settings/eSender' . $url, array('class' => 'form-horizontal form-bordered frm-submit-msg')); 
									$eSender = smsIsarray($api['esender']);
									?>
									<div class="panel-body">
										<div class="form-group mt-md">
										  <label  class="col-md-3 control-label">Api Key <span class="required">*</span></label>
											<div class="col-md-6">
												<input type="text" class="form-control" placeholder="" name="api_key" value="<?=$eSender['field_one']?>">
												<span class="error"></span>
											</div>
