<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('frontend/popup/index'); ?>"><i class="fas fa-list-ul"></i> <?php echo translate('news') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="edit">
			    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit-data')); ?>
					<input type="hidden" name="popup_id" value="<?php echo $gallery['id']; ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							...
							<input type="file" name="image" class="dropify" data-height="150" data-default-file="<?php echo $this->popup_model->get_image_url($gallery['image']); ?>" />
