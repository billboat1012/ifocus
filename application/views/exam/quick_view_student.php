...
<div style="position: relative; width: 100%; height: 100%;"> 
    ...
    style="border-color: transparent !important; width: 100%; min-height: 250px; text-align: center; margin-bottom: 20px; background-color: <?= $headerBgColor ?: '#0F335C' ?> !important;">
            <tr>
                ...
                <td style="width: 80%; text-align: center; padding: 50px;">
                    <h2 style="color: <?= $headerTextColor ?: '#fff' ?> !important; margin: 0; font-size: 26px; font-weight: bold;">
                        <?= $schoolName ?: $branchDetail->name; ?>
                    </h2>
                    <p style="margin: 10px 0; font-size: 16px; color: <?= $headerTextColor ?: '#fff' ?> !important;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            <th style="border: 1px solid #000; padding: 5px; text-align: center;">
                <tr style="border: 1px solid #000 !important">
                    <th colspan="10" class="text-center" style="background-color: <?= $headerTextColor ?: '#0F335C' ?> !important;-webkit-print-color-adjust: exact;text-align: center;color: <?= $headerBgColor ?: '#fff' ?> !important;font-weight: bold;font-size: 14px; padding: 6px;">STUDENT ACADEMIC PERFORMANCE RECORD</th>
                </tr>
            </th>
        </table>
        <?php
...
<?php } ?>
		...
		<div class="empty-space" style="height: 10px;float: left; width: 100%;clear: both;display: block;"></div>
                            ...
                            <table class="table table-condensed table-bordered" style="width:100%; margin: 0 !important;">
                                <tbody>
                                    ...
                                    <?php if ($getExam['type_id'] == 1 || $getExam['type_id'] == 3) { ?>
                                        ...
                                        <tr style="border: 1px solid #000 !important">
                                            <?php if ($extINTL == true) { ?>
                                                <td valign="top" style="font-size: 10px; padding: 4px;"><strong>Learners Average:</strong> <?php $percentage = ($grand_obtain_marks * 100) / $grand_full_marks;
                        ...
                        <td style="width:33.333%; padding: 0; vertical-align: top;">
                            <table style="width: 100%; margin: 0 !important;">
                                ...
                                <tr style="border: 1px solid #000 !important">
                                    ...
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->punctualtiy ? $rankDetail->punctualtiy : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">General Neatness</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->neatness ? $rankDetail->neatness : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Obedience</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->obedience ? $rankDetail->obedience : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Self Control</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->self_control ? $rankDetail->self_control : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Participation in Class</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->participation ? $rankDetail->participation : '-'; ?></td>
                                </tr>
                            </table>
                        </td>
                        <td style="width:33.333%; padding: 0; vertical-align: top;">
                            <table style="width: 100%; margin: 0 !important;">
                                ...
                                <tr style="border: 1px solid #000 !important">
                                    ...
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->use_of_intiative ? $rankDetail->use_of_intiative : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Handling of Tools</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->handling ? $rankDetail->handling : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Communication Skills</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->communication ? $rankDetail->communication : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Relationship with Others</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->realtionship ? $rankDetail->realtionship : '-'; ?></td>
                                </tr>
                                <tr style="border: 1px solid #000 !important">
                                    <td style="font-size: 10px; padding: 4px;">Sports & Games</td>
                                    <td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->sports ? $rankDetail->sports : '-'; ?></td>
                                </tr>
                            </table>
                        </td>
