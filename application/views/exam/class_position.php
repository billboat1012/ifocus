						...
						<table class="table table-bordered table-hover table-condensed mb-none" id="tableExport">
							...
							<thead class="text-dark">
								...
								<?php } ?>
									...
									<th><?=translate('punctualtiy')?></th>
									<th><?=translate('neatness')?></th>
									<th><?=translate('obedience')?></th>
									<th><?=translate('self_control')?></th>
									<th><?=translate('participation')?></th>
									<th><?=translate('use_of_intiative')?></th>
									<th><?=translate('handling')?></th>
									<th><?=translate('communication')?></th>
									<th><?=translate('realtionship')?></th>
							...
							<tbody>
								...
								//echo '<pre>'; print_r($students_list); echo '</pre>';
								...
								if(count($students_list)) {
									...
									foreach($students_list as $enroll) {
										...
										if($branch_id == $this->config->item('branch_for_forms_teacher_comments')){
										$studentArray['forms_teacher_comments'] = $enroll->forms_teacher_comments;
										};

										$studentArray['punctualtiy'] = $enroll->punctualtiy;
										$studentArray['neatness'] = $enroll->neatness;
										$studentArray['obedience'] = $enroll->obedience;
										$studentArray['self_control'] = $enroll->self_control;
										$studentArray['participation'] = $enroll->participation;
										$studentArray['use_of_intiative'] = $enroll->use_of_intiative;
										$studentArray['handling'] = $enroll->handling;
										$studentArray['communication'] = $enroll->communication;
										$studentArray['realtionship'] = $enroll->realtionship;
										$studentArray['sports'] = $enroll->sports;
								...
								if (!empty($studentArrayList)) {
									...
									$count = 1;
//echo '<pre>'; print_r($failStudentArrayList); echo '</pre>';
								...
								<?php } ?>
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][punctualtiy]" value="<?php echo (empty($row1['punctualtiy']) ? "" : $row1['punctualtiy']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][neatness]" value="<?php echo (empty($row1['neatness']) ? "" : $row1['neatness']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][obedience]" value="<?php echo (empty($row1['obedience']) ? "" : $row1['obedience']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][self_control]" value="<?php echo (empty($row1['self_control']) ? "" : $row1['self_control']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][participation]" value="<?php echo (empty($row1['participation']) ? "" : $row1['participation']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][use_of_intiative]" value="<?php echo (empty($row1['use_of_intiative']) ? "" : $row1['use_of_intiative']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][handling]" value="<?php echo (empty($row1['handling']) ? "" : $row1['handling']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][communication]" value="<?php echo (empty($row1['communication']) ? "" : $row1['communication']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][realtionship]" value="<?php echo (empty($row1['realtionship']) ? "" : $row1['realtionship']); ?>">
									...
									<td>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" autocomplete="off" name="rank[<?php echo $key ?>][sports]" value="<?php echo (empty($row1['sports']) ? "" : $row1['sports']); ?>">
