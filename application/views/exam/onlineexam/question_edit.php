					...
					<div class="col-md-<?php echo $widget; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								...
								echo form_dropdown("class_id", $arrayClass, set_value('class_id', $questions['class_id']), "class='form-control' id='class_id'
								required data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
							?>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<?php
								if(!empty(set_value('class_id', $questions['class_id']))) {
									...
									$query = $this->subject_model->getSubjectByClassSection(set_value('class_id', $questions['class_id']));
