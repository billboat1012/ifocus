	...
	<div class="tabs-custom">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="add">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								...
								echo form_dropdown("class_id", $arrayClass, $onlineexam['class_id'], "class='form-control' id='class_id'
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('limits_of_participation'); ?></label>
						<div class="col-md-6">
