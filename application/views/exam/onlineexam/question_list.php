					...
					<table class="table table-bordered table-condensed table-hover">
						...
						<tbody>
							<?php 
								...
								$this->db->select('class.name as class_name,subject.name as subject_name,questions.question,questions.type,questions.level,questions_manage.id,questions_manage.marks,questions_manage.neg_marks,question_group.name as group_name');
