		...
		<section class="panel">
			...
			<?php echo form_open($this->uri->uri_string());?>
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="control-label"><?=translate('slug')?> <span class="required">*</span></label>
						<?php
							$arrayBranch = [
                                '1' => '1ST TERM',
                                '2' => '2ND TERM',
							...
							echo form_dropdown("slug", $arrayBranch, set_value('slug'), "class='form-control' id='slug'
							data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
						?>
						<span class="error"><?=form_error('slug')?></span>
					</div>
				</div>
