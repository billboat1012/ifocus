...
<div class="row">
	<div class="col-md-12">
		<section class="panel">
			<?php echo form_open('exam/psychomotor_dev', array('class' => 'validate')); ?>
			...
			<section class="panel appear-animation" data-appear-animation="<?php echo $global_config['animations'];?>" data-appear-animation-delay="100">
				...
				<header class="panel-heading">
					<h4 class="panel-title">
						<i class="fas fa-users"></i> <?=translate('student') . " " . translate('result') . " : " . $exam_details->name;?>
					</h4>
				</header>
				<div class="panel-body">
				<?php 
						...
						<table class="table table-bordered table-hover table-condensed mb-none" id="tableExport">
							<thead class="text-dark">
								<tr>
									...
									<th>Use of Intiative</th>
									<th>Handling of Tools</th>
									<th>Communication Skills</th>
									<th>Realtionship with Others</th>
									<th>Sports & Games</th>
								</tr>
							</thead>
							<tbody>
