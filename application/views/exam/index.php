				...
				<table class="table table-bordered table-hover mb-none table-export">
					...
					<tbody>
						...
						<?php endif; ?>
							...
							<?php
							$resumption_date = $this->application_model->formatNiceDate($row['next_terms']);
							?>
							<td><?php echo $resumption_date; ?></td>
				...
				<?php echo form_open($this->uri->uri_string(), array('class' => 'frm-submit'));?>
					<div class="form-horizontal form-bordered mb-lg">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6">
                                <?php
                                    $array = $this->app_lib->getSelectByBranch('exam', $branch_id);
                                    if (empty($array)) {
                                        echo "No exams available for this branch."; 
                                    } else {
                                        echo form_dropdown("parent_exam_id", $array, set_value('parent_exam_id'), "class='form-control' id='parent_exam_id'
                                        data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
                                    }
                                ?>
                                <span class="error"></span>
						...
						<div class="form-group" id="exam_category_div" style="display: none;">
                                <label class="col-md-3 control-label"><?= translate('exam_category') ?> <span class="required">*</span></label>
                                <div class="col-md-6">
						...
						<div class="form-group">
						    ...
						    <div class="col-md-6">
                						<select name="unique_identifier" class="form-control">
                						    ...
                						    <option value="1st_ca">1ST CA</option>
                						    <option value="2nd_ca">2ND CA</option>
