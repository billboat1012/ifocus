		...
		<div class="profile-head">
			...
			<div class="col-md-12 col-lg-5 col-xl-5">
				...
				<ul>
					...
					<?php } ?>
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('class')?>"><i class="fas fa-school"></i></div> <?=$student['class_name']; ?></li>
...
?>
						<div class="row mb-md">
							<?php if (is_superadmin_loggedin()): ?><div class="col-md-<?php echo $div; ?> mb-sm">
								<div class="form-group">
							...
							<div class="col-md-<?php echo $div; ?> mb-sm">
								<div class="form-group">
									...
									<?php
										...
										echo form_dropdown("class_id", $arrayClass, set_value('class_id', $student['class_id']), "class='form-control' id='class_id' data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
									?>
						...
						<div class="table-responsive mb-md">
							<table class="table table-bordered table-hover table-condensed mb-none">
								<thead>
									<tr>
										<th width="50">#</th>
										<th><?=translate('from_class');?></th>
										<th><?=translate('from_session')?></th>
										<th><?=translate('promoted_class');?></th>
								...
								<tbody>
									...
									$historys = $this->db->get('promotion_history')->result();
										...
										<tr>
											<td><?php echo $count++;?></td>
											<td><?php echo get_type_name_by_id('class', $history->pre_class); ?></td>
											<td><?php echo get_type_name_by_id('schoolyear', $history->pre_session, 'school_year'); ?></td>
											<td><?php echo get_type_name_by_id('class', $history->pro_class); ?></td>
