...
<div class="row">
	...
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			...
			<div class="panel-body mb-md student-lists-lists">

				<table class="table table-bordered table-condensed table-hover table-export student-lists">

					<thead>

						<tr>

							<th width="10" class="no-sort no-export student-list-checkbox">
								<span class="show-in-mobile">Select All:</span>
					...
					<tbody>
						...
						<tr>
							...
							<td class="center image-area"><img src="<?php echo get_image_url('student', $row['photo']); ?>" height="50"></td>

							<td class="<?=($row['active'] == 0 ? 'text-danger' : '')?>"><span class="show-in-mobile"><?=translate('name')?>: </span><?php echo $row['fullname'];?></td>

							<td><span class="show-in-mobile"><?=translate('class')?>: </span><?php echo $row['class_name'];?></td>

							<td><span class="show-in-mobile"><?=translate('register_no')?>: </span><?php echo $row['register_no'];?></td>

							<td><span class="show-in-mobile"><?=translate('role')?>: </span><?php echo $row['roll'];?></td>

							<td>
							<span class="show-in-mobile"><?=translate('age')?>: </span>
							<?php
							...
							<td><span class="show-in-mobile"><?=translate('guardian_name')?>: </span><?php echo (!empty($row['parent_id']) ? get_type_name_by_id('parent', $row['parent_id']) : 'N/A');?></td>
						...
						<?php } } ?>
							...
							<td>
								<span class="show-in-mobile"><?=translate('fees_progress')?>: </span>
							...
							<td class="action">
								<span class="show-in-mobile"><?=translate('action')?>: </span>
								<!-- quick view -->
