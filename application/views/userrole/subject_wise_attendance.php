				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<?php
							...
							$query = $this->subject_model->getSubjectByClassSection($class_id);
...
$atten = $this->attendance_period_model->get_attendance_by_subjectID($studentID, $class_id, $date, $day, $subject_id);
?>
							<td class="center">
