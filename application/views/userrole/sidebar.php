...
<?php } ?>
                   ...
                   <!-- fees history -->
                    ...
                    <!--exam prep zone -->
                    <li class="nav-parent <?php if ($main_menu == 'exam_preparation') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="icons icon-notebook"></i><span><?=translate('Exam Preparation Zone')?></span>
                        </a>
                        <ul class="nav nav-children">
                            <li class="<?php if ($sub_page == 'exam_preparation/index') echo 'nav-active';?>">
                                <a href="<?=base_url('exam_preparation/index')?>">
                                    <span><i class="fas fa-caret-right"></i><?=translate('Dashboard')?></span>
                                </a>
                            </li>
                            <li class="<?php if ($sub_page == 'exam_preparation/leaderboard') echo 'nav-active';?>">
                                <a href="<?=base_url('exam_preparation/leaderboard')?>">
                                    <span><i class="fas fa-caret-right"></i><?=translate('Leaderboard')?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
