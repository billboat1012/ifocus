        ...
        <table class="table table-condensed table-bordered section-spacing" style="margin: 10px 0 !important;">
            <thead>
                <tr class="academic-record-heading">
                    <th style="background-color: <?= $headerTextColor ?: '#0F335C' ?> !important;-webkit-print-color-adjust: exact;text-align: center;color: <?= $headerBgColor ?: '#fff' ?> !important;font-weight: bold;font-size: 14px; padding: 6px;">STUDENT ACADEMIC PERFORMANCE RECORD</th>
                </tr>
            ...
            ?>
                ...
                ?>
                    ...
                    <?php } ?>
                    <?php if ($marksheet_template['remark'] == 1) { ?>
                    <td valign="middle" style="font-size: 10px; padding: 4px; color:<?php if($grade['remark']=='FAIL'){ echo 'red'; }else{ echo 'green'; } ?>;"><?=$grade['remark']?></td>
                    <?php } ?>
                <?php } ?>
                </tr>
            <?php } ?>
                ...
                <td style="width: 60%; padding: 0; vertical-align: top;">
                    <table class="table table-condensed table-bordered" style="width:100%; margin: 0 !important;">
                        <tbody>
                            ...
                            <tr style="border: 1px solid #000 !important">
                                <?php if ($extINTL == true) { ?>
                                <td valign="top" style="font-size: 10px; padding: 4px;"><strong>Learners Average:</strong> <?php $percentage = ($grand_obtain_marks * 100) / $grand_full_marks; echo number_format($percentage, 2, '.', '')?>%</td>
                                <?php } ?>
                                <?php } if ($getExam['type_id'] == 2) { ?>
                    ...
                    $getTotalWorking = $this->db->where(array('enroll_id' => $student['enrollID'], 'year(date)' => $year[1]))->get('student_attendance')->num_rows();
                    $getTotalAttendance = $this->db->where(array('enroll_id' => $student['enrollID'], 'status' => 'P', 'year(date)' => $year[1]))->get('student_attendance')->num_rows();
                    ...
                    <table class="table table-bordered table-condensed" style="width: 100%; margin: 10px 0 !important;" class="section-spacing">
                        <tbody>
                            ...
                            <tr style="border: 1px solid #000 !important">
                                ...
                                <td style="font-size: 10px; padding: 4px;"><?=$getTotalWorking?></td>
                            </tr>
                            <tr style="border: 1px solid #000 !important;">
                                <th style="width: 65%; font-size: 10px; padding: 4px;">No. of days attended</th>
                                <td style="font-size: 10px; padding: 4px;"><?=$getTotalAttendance?></td>
                            </tr>
                            <tr style="border: 1px solid #000 !important">
    ...
    <tr style="border: 1px solid #000 !important">
        <td style="width:33.333%; padding: 0; vertical-align: top;">
            <table style="width: 100%; margin: 0 !important;">
                ...
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Punctuality</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->punctualtiy ? $rankDetail->punctualtiy : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">General Neatness</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->neatness ? $rankDetail->neatness : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Obedience</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->obedience ? $rankDetail->obedience : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Self Control</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->self_control ? $rankDetail->self_control : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Participation in Class</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->participation ? $rankDetail->participation : '-'; ?></td></tr>
            </table>
        </td>
        <td style="width:33.333%; padding: 0; vertical-align: top;">
            <table style="width: 100%; margin: 0 !important;">
                ...
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Use of Intiative</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->use_of_intiative ? $rankDetail->use_of_intiative : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Handling of Tools</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->handling ? $rankDetail->handling : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Communication Skills</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->communication ? $rankDetail->communication : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Relationship with Others</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->realtionship ? $rankDetail->realtionship : '-'; ?></td></tr>
                <tr style="border: 1px solid #000 !important"><td style="font-size: 10px; padding: 4px;">Sports & Games</td><td style="font-size: 10px; padding: 4px;"><?php echo $rankDetail->sports ? $rankDetail->sports : '-'; ?></td></tr>
            </table>
        </td>
