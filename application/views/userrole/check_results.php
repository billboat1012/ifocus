...
<section class="panel">
    <header class="panel-heading">
        <h4 class="panel-title"><i class="fas fa-list-ul"></i> <?= translate('check_result')  ?></h4>
    </header>
    <div class="panel-body">
        <table class="table table-bordered table-hover mb-none table-condensed exam-list" width="100%">
            <div class="container px-md-0 main-container">
                ...
                <?php echo form_open('userrole/examResultsPrintFn-stu', array('class' => 'printIn')); ?>
                        ...
                        <div class="col-md-4 mb-sm">
                            <div class="form-group">
                                ...
                                if (is_student_loggedin()) {
                                    $regNo = $stu['register_no'];
                                ?>
                                <label class="control-label"> <?= translate('register_no') ?> <span class="required">*</span></label>
                                <input type="text" class="form-control"  value="<?php echo $regNo; ?>" autocomplete="off" disabled/>
                                <input type="hidden" class="form-control" name="register_no" value="<?php echo $regNo; ?>"/>
                                <span class="error"></span>
                                <?php } else {?>
