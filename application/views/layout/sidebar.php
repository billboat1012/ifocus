            ...
            <nav id="menu" class="nav-main" role="navigation">
                ...
                <ul class="nav nav-main">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'frontend') echo 'nav-expanded nav-active'; ?>">
                       ...
                       <?php } if(get_permission('frontend_menu', 'is_view')){ ?>
                        ...
                        <?php } if(get_permission('frontend_section', 'is_view')){ ?>
                            ...
                            <?php } if(get_permission('frontend_popup', 'is_view')){ ?>

                            <li class="<?php if ($sub_page == 'frontend/popup' || $sub_page == 'frontend/popup_edit') echo 'nav-active'; ?>">

                                <a href="<?php echo base_url('frontend/popup/index'); ?>">

                                    <span><i class="fas fa-caret-right"></i><?php echo translate('popup'); ?></span>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'student') echo 'nav-expanded nav-active';?>">
                        ...
                        <?php } if(get_permission('create_login', 'is_view')){ ?>
                        
                            <li class="<?php if ($sub_page == 'student/create_login') echo 'nav-active';?>">

                                <a href="<?=base_url('student/create_login')?>">

                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('create_login')?></span>
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'subject/teacher_assign') echo 'nav-active';?>">
                                        ...
                                        <a href="<?=base_url('subject/teacher_assign')?>">
                                            ...
                                            <span><?=translate('teacher_assign')?></span>
                                    ...
                                    <?php if(get_permission('sub_subject', 'is_view')) { ?>

                                    <li class="<?php if ($sub_page == 'subject/sub_subject') echo 'nav-active';?>">

                                        <a href="<?=base_url('subject/sub_subject')?>">

                                            <span><?=translate('sub_subject')?></span>
                    ...
                    get_permission('sub_mark_distribution', 'is_view') ||
                    ...
                    get_permission('hostel_comments', 'is_view')) {
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'exam_term' || $main_menu == 'exam_hall' || $main_menu == 'marksheet_template') echo 'nav-expanded nav-active';?>">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <?php } if (get_permission('sub_mark_distribution', 'is_view')) { ?>

                                    <li class="<?php if ($sub_page == 'exam/sub_mark_distribution') echo 'nav-active';?>">

                                        <a href="<?=base_url('exam/sub_mark_distribution')?>">

                                            <span><?=translate('sub_distribution')?></span>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'mark') echo 'nav-expanded nav-active';?>">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'exam/attendance_update') echo 'nav-active';?>">

                                        <a href="<?=base_url('exam/attendance_update')?>">

                                            <span><?=translate('attendance_update')?></span>
                                    ...
                                    <?php } if (get_permission('exam_mark', 'is_view')) { ?>
                                    <?php if (is_superadmin_loggedin() || ($this->session->userdata('loggedin_type') == 'staff' || $this->session->userdata('loggedin_type') == 'admin' && $this->session->userdata('loggedin_branch') == $this->config->item('branch_for_special_feature'))) { ?>
                                        <?php if (is_superadmin_loggedin() || $this->session->userdata('loggedin_role_id') == $this->config->item('teacher_id') || $this->session->userdata('loggedin_role_id') == $this->config->item('admin_id')) { ?>
                                            <li class="<?php if ($sub_page == 'exam/hostel_comments') echo 'nav-active'; ?>">
                                                <a href="<?= base_url('exam/hostel_comments') ?>">
                                                    <span><?= translate('hostel_comments') ?></span>
                                                </a>
                                            </li>
                                        <?php } ?>
                                    <?php } ?>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'accounting_repots' ||
                        ...
                        <?php if(get_permission('report_card', 'is_view') || get_permission('tabulation_sheet', 'is_view') ||
                            get_permission('tabulation_sheet_reports', 'is_view') ||
                            get_permission('progress_reports', 'is_view')) { ?>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'exam_reports') echo 'nav-expanded nav-active'; ?>">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'exam/spread_sheet') echo 'nav-active';?>">

                                        <a href="<?=base_url('exam/spread_sheet')?>">

                                            <span><?=translate('spread_sheet')?></span>
