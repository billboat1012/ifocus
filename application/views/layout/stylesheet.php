...
<link rel="stylesheet" href="<?php echo base_url('assets/vendor/owlcarousel/css/owl.carousel.min.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/vendor/owlcarousel/css/owl.theme.default.min.css') ?>">
<?php if ($this->app_lib->isRTLenabled()) { ?>
