...
<?php if (get_permission('marksheet_template', 'is_add')): ?>
			<div class="tab-pane" id="add">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="school_name" value="" placeholder="~" />
						</div>
					</div>
					<div class="form-group">
					    <label class="col-md-3 control-label">Header Bg Color</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="header_bg_color" value="" placeholder="#000" />
						</div>
					</div>
					<div class="form-group">
					    <label class="col-md-3 control-label">Header Text Color</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="header_text_color" value="" placeholder="#000" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-md-offset-3 col-md-8">
							...
							<div class="checkbox-replace mt-sm mb-lg">
								<label class="i-checks">
									<input type="checkbox" name="playgroup" value="true"><i></i> <?php echo translate('playgroup'); ?>
								</label>
							</div>
						</div>
					</div>
