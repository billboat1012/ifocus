		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="edit">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="school_name" value="<?=$certificate['school_name']?>" placeholder="~" />
						</div>
					</div>
                    <div class="form-group">
					    <label class="col-md-3 control-label">Header Bg Color</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="header_bg_color" value="<?=$certificate['header_bg_color']?>" placeholder="#000" />
						</div>
					</div>
					<div class="form-group">
					    <label class="col-md-3 control-label">Header Text Color</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="header_text_color" value="<?=$certificate['header_text_color']?>" placeholder="#000" />
						</div>
					</div>
					...
					<input type="hidden" name="old_stamp_file" value="<?=$certificate['stamp']?>">
					...
					<div class="form-group">
						...
						<label class="col-md-3 control-label">Stamp</label>
						...
						<div class="col-md-offset-3 col-md-8">
							...
							<div class="checkbox-replace mt-sm mb-lg">
								...
								<label class="i-checks">
									...
									<input type="checkbox" name="playgroup" value="true" <?php echo $certificate['playgroup'] == 1 ? 'checked' : ''; ?>><i></i> <?php echo translate('playgroup'); ?>
