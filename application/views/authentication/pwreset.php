...
<head>
	...
	<body>
		<div class="auth-main">
			<div class="container m-4 login-main-container">
				<div class="slideIn">
					<!-- image and information -->
                    <div class="col-lg-7 d-flex align-items-center justify-content-start col-md-6 col-sm-12 col-xs-12 no-padding fitxt-center">
				    ...
				    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 no-padding">
						<div class="sign-area">
							<div class="sign-hader">
								...
								<h2 style="color: #212121 !important"><?php echo $global_config['institute_name'];?></h2>
							</div>
