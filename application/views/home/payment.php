            ...
            <section class="container">
                <div class="row">
                    <div class="col-md-6" style="margin: auto 0;">
                        ...
                        <h4>The amount of admission fee required of <strong style="color: #5e5e5e;"><?php echo $get_student['first_name'] . " " . $get_student['last_name'] ?></strong> </h4>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="branch_id" value="<?php echo $get_student['branch_id']; ?>">
                        <input type="hidden" name="currency" value="<?php echo $get_student['currency']; ?>">
                        <input type="hidden" name="amount" value="<?php echo $get_student['fee_elements']['amount']; ?>">
