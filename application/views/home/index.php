...
<?php
    $popup_list = $this->home_model->getPopup($branchID);
    if (!empty($popup_list)) {
        $url_alias = $cms_setting['url_alias'];
    ?>
                    <?php foreach ($popup_list as $key => $value) { ?>
                     <div class="overlay overlay-close p-3" id="popUpOverlay">
  <img src="<?php echo base_url('uploads/frontend/popups/' . $value->image); ?>" class="popup-image closeOverlay rounded-3" alt="<?php echo $value->title; ?>">
  <div class="close-overlay overlay-close closeOverlay" id="closeOverlay">x</div>
</div>
    ...
    <div class="container-fluid">
        <ul class="main-slider-carousel owl-carousel owl-theme slide-nav">
            ...
            <li class="slider-wrapper">
                <div class="image" style="background-image: url(<?php echo base_url('uploads/frontend/slider/' . $elements['image']) ?>); height: 100vh;" ></div>
                <div class="slider-caption <?php echo $elements['position'];  ?>">
                    <div class="container d-flex align-items-center justify-content-center">
                        <div class="wrap-caption">
                            <h1 class="text-center"><?php echo $value['title']; ?></h1>
                            <div class="text text-center"><?php echo $value['description']; ?></div>
                            <div class="link-btn d-flex align-items-center justify-content-center">
                                <a href="<?php echo $elements['button_url1']; ?>" style="font-size: 0.6rem" class="btn rounded-start-4">
                                    <?php echo $elements['button_text1']; ?>
                                </a>
                                <a href="<?php echo $elements['button_url2']; ?>" style="font-size: 0.6rem" class="btn btn1 rounded-end-4">
                ...
                <div class="slide-overlay bg-secondary" style="opacity:0"></div>
            </li>
            <?php } ?>
        </ul>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="sec-title style-two mb-tt">
                    ...
                    <span class="decor mt-2 mb-2"><span class="inner"></span></span><br>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="bio-box">
                    <div class="profile-img">
                        ...
                        <div class="dlab-media" style="width:100%; height:300px; object-fit:cover;">
