...
$route['webhook'] = 'webhook/receive';
$route['privacy-policy'] = 'privacy_policy/privacy_policy';
...
$route['userrole/check-results'] = 'Userrole/check_results_stu';
$route['userrole/examResultsPrintFn-stu'] = 'Userrole/examResultsPrintFn';
...
$route['pin'] = 'pin/index';
$route['create-pin'] = 'pin/create';
$route['delete-pin/(:any)'] = 'pin/delete/$1';
...
// custom
$route['ajax/getDistributionOptions'] = 'ajax/getDistributionOptions';
$route['userrole/getStudentDetailedResult/(:num)'] = 'userrole/getStudentDetailedResult/$1';