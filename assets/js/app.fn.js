(function($) {
    ...
    $.ajax({
        ...
        beforeSend: function () {
            btn.button('loading');
            console.log('Serialized data:', $this.serialize()); // Debug
        },
        success: function (data) {
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error('AJAX Error:', textStatus, errorThrown, jqXHR.responseText); // Debug
            btn.button('reset');
        }
    });
});
...
function getSubjectByBranch(branchID) {
    $.ajax({
        ...
        beforeSend: function () {
            $('#subject_id-container').parent().addClass('select2loading');
        },
        success: function (data) {
        ...
        complete: function () {
            $('#subject_id-container').parent().removeClass('select2loading');
        }
    });

    $('#section_id').html('');
    $('#section_id').append('<option value="">Select Branch First</option>');
}
